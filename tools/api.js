...
var _api_root = ""; 
if (-1 != siteinfo.acid) {
	_api_root = _api_root = siteinfo.base_url + "addons/zjhj_mall/core/web/index.php?_acid=" + siteinfo.acid + "&r=api/";
...
var api = {
	...
	default: {
		...
		config: _api_root + "default/config", 
		ms_list:_api_root + "panic-buy/ms-list", 
	},
	cart: {
	...
	user: {
		...
		UpdateUser: _api_root + "user/update-user",
		get_user_info: _api_root + "user/update-user",
	}, 
	share: {
		...
		get_money_log: _api_root + "share/get-money-log",
		mini_qrcode: _api_root + "share/mini-qrcode"
	},
	coupon: {
	...
	live: {
		scene_detail: _api_root + 'live/scene-detail',
		ImLogin: _api_root + "im/login",
		list: _api_root + "live/list",
		post: _api_root + 'live/post',
		detail: _api_root + 'live/detail',
		apply_anchor: _api_root + 'live/apply-anchor',
		follow: _api_root + 'live/follow',
		follow_list: _api_root + 'live/follow-list',
		my_live_notice: _api_root + 'live/my-live-notice',
		my_live: _api_root + 'live/my-live',
		report: _api_root + 'live/report',
		set_like: _api_root + 'live/set-like',
		close_live: _api_root + 'live/close-live',
		update_counter: _api_root + 'live/update-counter',
		msg: _api_root + 'live/msg',
		del_notice_live: _api_root + 'live/del-notice-live',
		scene_detail: _api_root + 'live/scene-detail',
		blogger: _api_root + 'live/blogger',
		blogger_goods: _api_root + 'live/blogger-goods',
		start_live: _api_root + 'live/start-live',
	},
	anchor_order: {
		list: _api_root + 'anchor-order/list', //直播订单
		detail: _api_root + 'anchor-order/detail', //订单详情
		express: _api_root + 'anchor-order/express', //物流信息 
		anchor_goods_detail: _api_root + 'live/anchor-goods-detail', //商品详情
		anchor_goods_add: _api_root + 'live/anchor-goods-add', //商品提交
		goods_list: _api_root + 'live/goods-list', //产品库
		choose_goods: _api_root + 'live/choose-goods', //选择商品列表
		del_relation_goods: _api_root + 'live/del-relation-goods', //删除平台 商户商品
		submit_selected_goods: _api_root + 'live/submit-selected-goods', //选择商品提交
		del_anchor_goods: _api_root + 'live/del-anchor-goods', //删除主播商品
		send: _api_root + 'anchor-order/send', //发货  
		cash: _api_root + 'anchor-order/cash', //提现  
		cash_log: _api_root + 'anchor-order/cash-log',//提现明细
	},
	live_order: {
		submit_preview: _api_root + 'live-order/submit-preview', //直播下单
		submit: _api_root + 'live-order/submit', //直播订单提交
		pay_data: _api_root + 'live-order/pay-data', //直播订单提交
	},
	college: {
		list: _api_root + "college/list",
		detail: _api_root + 'college/detail',
		pay_course_order: _api_root + 'college/pay-course-order',
		class: _api_root + 'college/class',
		course_video_list: _api_root + 'college/course-video-list',
		course_detail: _api_root + 'college/course-detail',
		course_item_detail: _api_root + 'college/course-item-detail',
